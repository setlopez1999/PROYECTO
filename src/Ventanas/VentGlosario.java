 ...
 * @author ESTUDIANTE
 */
public class VentGlosario extends javax.swing.JFrame {

    VentPrincipal padre;
    int x,y;
    
    public VentGlosario(VentPrincipal padre) {
        initComponents();
    ...
    public void Salir(){
        this.dispose();
        VentPrincipal ventana = new VentPrincipal(padre.usuarioActual, padre.login);
    }
