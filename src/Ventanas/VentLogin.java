...
public class VentLogin extends javax.swing.JFrame {
    ...
    public VentLogin() {
        ...
        AgregarUsuario("user","","73666627");
        AgregarUsuario("set","","73666627");
        Vaciar();   
    }
    ...
    private void initComponents() {
        ...
        jPanel1.add(btnAdmin, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 90, 50));
    ...
    private void registrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_registrarMouseClicked
        ...
        VentRegistrar vent = new VentRegistrar(this);
    ...
    private void lblEntrarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblEntrarMouseClicked
        ...
        if(ValidarUsuario()){
            ...
            VentPrincipal vent = new VentPrincipal(usuarioLogueado,this);
            this.dispose();
        }
