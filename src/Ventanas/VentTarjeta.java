...
public class VentTarjeta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        panelAjustes1.add(subtemaActual, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 0, 800, -1));

        tarjetaActual.setBackground(new java.awt.Color(100, 50, 100, 01));
        tarjetaActual.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        ...
        tarjetaActual.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        ...
        panelAjustes1.add(tarjetaActual, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 1030, 410));

        jPanel1.add(panelAjustes1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 110, 1110, 480));
        ...
        fav.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/Star 1.png"))); // NOI18N
    ...
    private void btnVolverMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnVolverMouseClicked
        VentTema ventana = new VentTema(padre);
