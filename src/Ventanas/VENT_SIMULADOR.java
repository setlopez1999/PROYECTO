 ...
 * @author ESTUDIANTE
 */
public class VENT_SIMULADOR extends javax.swing.JFrame {
     ...
     */
    public VENT_SIMULADOR(VENT_PRINCIPAL padre) {
        initComponents();
        this.padre = padre;
    }
    ...
    private void btnCompletar4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCompletar4ActionPerformed
        ...
        if (completo){
            ...
            JOptionPane.showMessageDialog(null,
                ...
                "Pantalla Completada",
                JOptionPane.INFORMATION_MESSAGE);
            FrameReconocimiento reconocimiento = new FrameReconocimiento(padre);
